...
aboutMe =
    ...
    , bio =
        [ "As a developer, I am a leader, an architect, and a DevEx advocate.  I love good documentation, clean code, and using the right tools without chasing hype without other reasons.  I am a proven 10X developer on my teams; delivering high quality code in a fraction of the time expected of me.  I am curious, and will dive into new topics to solve them no matter what."
