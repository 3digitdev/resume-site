...
{
	if (region.L.A === region.S.A)
	{
		return 'on line ' + region.L.A;
	}
	return 'on lines ' + region.L.A + ' through ' + region.S.A;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aO: 'hidden', az: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aO: 'mozHidden', az: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aO: 'msHidden', az: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aO: 'webkitHidden', az: 'webkitvisibilitychange' }
		: { aO: 'hidden', az: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {U: fragment, W: host, aY: path, aa: port_, ad: protocol, ae: query};
	});
...
var $author$project$ResumePage$Helpers$About = 0;
var $author$project$Resume$Resume = F5(
	function (aboutPage, workHistoryPage, educationPage, skillsPage, portfolioPage) {
		return {O: aboutPage, aE: educationPage, aZ: portfolioPage, a1: skillsPage, ba: workHistoryPage};
	});
...
var $author$project$ResumePage$Types$FormalEducation = F5(
	function (school, gradDate, degree, gpa, info) {
		return {aC: degree, aL: gpa, aM: gradDate, X: info, ai: school};
	});
...
var $author$project$Main$myEducation = $elm$core$Maybe$Just(
	{
		...
		aX: $author$project$ResumePage$Types$OtherEducation(
			_List_fromArray(
				[
					$author$project$ResumePage$Helpers$TextItem('Have done extensive work on my own time to learn new technologies and languages'),
					$author$project$ResumePage$Helpers$TextItem('Have studied both frontend and backend languages/frameworks'),
					$author$project$ResumePage$Helpers$TextItem('Deploy and manage self-made webapps with full CI/CD pipeline'),
					$author$project$ResumePage$Helpers$TextItem('Have taken online courses at times for various things including AWS and React')
				]))
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$ResumePage$Helpers$TextItem('Pokedex Mode:  Allows searching by name. Links types to Type Matchup Mode'),
								$author$project$ResumePage$Helpers$TextItem('Type Matchup Mode:  Select 1-2 types, and get information about the type regarding offense, defense, and suggested Pokemon'),
								$author$project$ResumePage$Helpers$TextItem('Party Planner Mode:  Enter your party members in and get an evaluation of your party regarding type matchups, including suggestions on types to fill gaps')
							])),
						$author$project$ResumePage$Types$ImageCard('swshdex-pp.png'),
						A2(
						$author$project$ResumePage$Types$TextCard,
						'Tech Stack',
						_List_fromArray(
							[
								$author$project$ResumePage$Helpers$TextItem('Entire app is written in Elm'),
								A2($author$project$ResumePage$Helpers$LinkItem, 'https://elm-lang.org/', 'Elm Language'),
								$author$project$ResumePage$Helpers$TextItem('Data is handled with static JSON files for now'),
								$author$project$ResumePage$Helpers$TextItem('(See README on why I\'m not using an API)'),
								$author$project$ResumePage$Helpers$TextItem('CSS is provided by:'),
								A2($author$project$ResumePage$Helpers$LinkItem, 'https://github.com/nostalgic-css/NES.css', 'NES.css')
							]))
					])),
				A2(
				$author$project$ResumePage$Types$PortfolioItem,
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$ResumePage$Helpers$LinkItem, 'https://nim-lang.org/', 'Nim Language'),
						...
						$author$project$ResumePage$Types$ImageCard('verbly-ta.png'),
						$author$project$ResumePage$Types$ImageCard('verbly-tr.png'),
						A2(
						$author$project$ResumePage$Types$TextCard,
						'CI/CD',
						_List_fromArray(
							[
								$author$project$ResumePage$Helpers$TextItem('App is deployed on semver tags'),
								$author$project$ResumePage$Helpers$TextItem('GitHub Action deploys the Elm portion to Firebase'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$ResumePage$Helpers$TextItem('This resume website is built on an unmodified fork of the project!'),
								$author$project$ResumePage$Helpers$TextItem('Only code modified is in \'Main.elm\' to define resume parts')
							]))
					]))
			])
	});
var $author$project$ResumePage$Types$Skill = F3(
	function (name, rating, blurb) {
		return {av: blurb, aS: name, a_: rating};
	});
...
var $author$project$ResumePage$Types$Job = F5(
	function (employer, startDate, endDate, title, info) {
		return {aH: employer, aI: endDate, X: info, a3: startDate, a6: title};
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					$author$project$ResumePage$Helpers$TextItem('Conceptualized, designed, planned, and currently executing a large-scale refactor of our API to a new major version using well-defined REST principles and usability features'),
					$author$project$ResumePage$Helpers$TextItem('Helping lead the way for better code quality, better tests, and most importantly better documentation of our architecture'),
					$author$project$ResumePage$Helpers$TextItem('Mentoring and on-boarding of multiple engineers at various skill levels with our codebase and teaching them code quality techniques'),
					$author$project$ResumePage$Helpers$TextItem('Customer-facing support rotation and helping debug issues live on a K8s cluster'),
					$author$project$ResumePage$Helpers$TextItem('Working with a combination of Customers, UX designer, Product Owners, and Front-end team to deliver code that works well and is helpful, along with defining realistic features and plans')
				])),
			A5(
			$author$project$ResumePage$Types$Job,
			'Northwestern Mutual',
...
var $author$project$Main$initModel = F2(
	function (url, key) {
		return {G: key, p: 0, F: $author$project$Main$myResume, N: url};
	});
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A2($author$project$Main$initModel, url, key),
...
var $author$project$ResumePage$Helpers$Education = 2;
var $author$project$ResumePage$Helpers$Portfolio = 4;
var $author$project$ResumePage$Helpers$Skills = 3;
var $author$project$ResumePage$Helpers$Work = 1;
...
var $author$project$ResumePage$Helpers$urlToPage = function (url) {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				var url = msg.a;
				var page = $author$project$ResumePage$Helpers$urlToPage(url.aY);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{p: page, N: url}),
...
var $author$project$ResumePage$About$renderLocation = function (aboutPage) {
	var stProv = A3($elm_community$maybe_extra$Maybe$Extra$unwrap, _List_Nil, $elm$core$List$singleton, aboutPage.a4);
	var country = A3($elm_community$maybe_extra$Maybe$Extra$unwrap, _List_Nil, $elm$core$List$singleton, aboutPage.aB);
	var city = A3($elm_community$maybe_extra$Maybe$Extra$unwrap, _List_Nil, $elm$core$List$singleton, aboutPage.aA);
	var parsedText = A2(
		$elm$core$String$join,
		'',
		A2(
...
var $author$project$ResumePage$Helpers$RGBA = F4(
	function (red, green, blue, alpha) {
		return {aq: alpha, au: blue, aN: green, a$: red};
	});
		...
		$elm$core$List$concat(
			_List_fromArray(
				[
					_List_fromArray(
					[
						$author$project$ResumePage$About$renderAvatar(aboutPage.as),
						A2(
						$elm$html$Html$h2,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(aboutPage.aS)
							])),
						$author$project$ResumePage$About$renderLocation(aboutPage),
						$author$project$ResumePage$About$renderEmail(aboutPage.aG)
					]),
					$author$project$ResumePage$About$renderSocial(aboutPage.a2),
					$author$project$ResumePage$About$renderBio(aboutPage.at)
				])));
};
...
var $author$project$ResumePage$Helpers$renderInfoList = function (infoList) {
	return A2(
		$elm$core$List$map,
		function (item) {
			if (item.$ === 1) {
			...
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href(bootCamp.a9)
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(bootCamp.ai)
											]))
									]))
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										A2($author$project$ResumePage$Helpers$formatStartEndDate, bootCamp.a3, bootCamp.aI))
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						$author$project$ResumePage$Helpers$renderInfoList(bootCamp.X))
					]))
			]));
};
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(formalEducation.ai)
									]))
							])),
						A2(
						$elm$html$Html$span,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(formalEducation.aM)
									]))
							])),
						A2(
						$elm$html$Html$span,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(formalEducation.aC)
									]))
							])),
						A2(
						$elm$html$Html$span,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(formalEducation.aL)
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						$author$project$ResumePage$Helpers$renderInfoList(formalEducation.X))
					]))
			]));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(item.a6)
									]))
							]))
					])),
				$author$project$ResumePage$Portfolio$renderCardGroup(item.ay)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$ResumePage$Skills$toStars(skill.a_)),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(skill.av)
					]))
			]));
};
...
var $author$project$ResumePage$WorkHistory$renderJob = function (job) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('job row full-shadow')
			]),
		_List_fromArray(
			[
				A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										A2($author$project$ResumePage$Helpers$formatStartEndDate, job.a3, job.aI))
									]))
							])),
						A2(
						$elm$html$Html$span,
				...
				_List_fromArray(
					[
						...
						$author$project$ResumePage$Helpers$renderInfoList(job.X))
					]))
			]));
};
...
var $author$project$Resume$renderSelectedPage = F2(
	function (resume, selectedPage) {
		switch (selectedPage) {
			case 0:
				return $author$project$ResumePage$About$renderAboutPage(resume.O);
			case 1:
				return A2($author$project$ResumePage$Helpers$emptyDivOr, $author$project$ResumePage$WorkHistory$renderWorkHistoryPage, resume.ba);
			case 2:
				return A2($author$project$ResumePage$Helpers$emptyDivOr, $author$project$ResumePage$Education$renderEducationPage, resume.aE);
			case 3:
				return A2($author$project$ResumePage$Helpers$emptyDivOr, $author$project$ResumePage$Skills$renderSkillsPage, resume.a1);
			default:
				return A2($author$project$ResumePage$Helpers$emptyDivOr, $author$project$ResumePage$Portfolio$renderPortfolioPage, resume.aZ);
		}
	});
...
var $author$project$ResumePage$Helpers$pageIcon = F2(
	function (page, color) {
		var size = 30;
		switch (page) {
			case 0:
...
var $author$project$ResumePage$Helpers$pageLink = function (page) {
	switch (page) {
		case 0:
			return 'about';
		case 1:
		...
		var validPages = $elm$core$List$concat(
			_List_fromArray(
				[
					...
					_List_Nil,
					function (_v0) {
						return $elm$core$List$singleton(1);
					},
					resume.ba),
					A3(
					$elm_community$maybe_extra$Maybe$Extra$unwrap,
					_List_Nil,
					function (_v1) {
						return $elm$core$List$singleton(2);
					},
					resume.aE),
					A3(
					$elm_community$maybe_extra$Maybe$Extra$unwrap,
					_List_Nil,
					function (_v2) {
						return $elm$core$List$singleton(3);
					},
					resume.a1),
					A3(
					$elm_community$maybe_extra$Maybe$Extra$unwrap,
					_List_Nil,
					function (_v3) {
						return $elm$core$List$singleton(4);
					},
					resume.aZ)
				]));
		return A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														$author$project$ResumePage$Helpers$pageString(model.p))
													]))
											]))
									]))
							])),
						A2($author$project$Main$renderNavBar, model.F, model.p),
						A2($author$project$Resume$render, model.p, model.F)
					]))
			]),
		a6: $author$project$ResumePage$Helpers$pageString(model.p)
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{aQ: $author$project$Main$init, aU: $author$project$Main$UrlChanged, aV: $author$project$Main$LinkClicked, a5: $author$project$Main$subscriptions, a7: $author$project$Main$update, a8: $author$project$Main$view});
